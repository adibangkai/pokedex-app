...
const JapaneseName = ({ url }) => {
  ...
  if (species.isLoading) {
    return (
      <>
        <p
          className={`invisible md:visible font-semibold md:pt-5 md:text-[160px] capitalize md:pl-20 text-zinc-200
...
const Details = () => {
  ...
  return (
    <div
      className={`transition duration-150 ease-in-out  mt-5 flex flex-col md:grid grid-cols-6 gap-1 min-h-screen max-h-full ${
        gradientType[pokemon.types[0].type.name]
      } `}
    >
      <div className="pl-0 md:pl-5 z-10">
        <p className="font-semibold text-2xl pt-4 md:pl-20 pl-4">
          #{addLeadingZeros(pokemon.id, 3)}
        </p>
        <p className="font-semibold text-4xl md:pl-20 pl-4 capitalize whitespace-nowrap">
          {pokemon.name}
        </p>
        <JapaneseName url={pokemon.species.url} />
        <div className="md:pl-20 pl-4 md:mt-48 mt-0">
      ...
      <div className="absolute z-0 md:relative md:col-span-3 flex ">
        <img
        ...
        <div className="grid  md:visible invisible">
      ...
      <div className=" col-span-2 p-8 mt-20 md:mt-0">
        <div className="flex text-xl invisible md:visible md:absolute md:top-14  bottom-0 font-mono md:right-10">
      ...
      <div className="flex text-xl visible md:invisible md:absolute md:top-14  bottom-0 font-mono md:right-10">
        <ul className="flex gap-2 mx-auto overflow">
          <Link to={`/pokedex-app/details/${pokemon.id - 1}`}>
            <li className="hover:font-semibold">{"<"}</li>
          </Link>
